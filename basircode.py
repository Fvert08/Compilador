...
Código IR:
    ...
    GLOBAL_GET name          ; Read a global variable onto the stack (Ingresa el valor en el stack)
    GLOBAL_SET name          ; Save a global variable from the stack (Toma el valor de el stack)
